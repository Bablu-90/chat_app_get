...
class CenterNextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final loginButtonMoveAnimation =
            ...
            child: AnimatedBuilder(
                ...
                builder: (context, child) => Padding(
                    padding: EdgeInsets.only(
                        bottom: 38 - (38 * loginButtonMoveAnimation.value)),
                    child: Container(
                        height: 58,
                        width: 58 + (200 * loginButtonMoveAnimation.value),
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(
                              8 + 32 * (1 - loginButtonMoveAnimation.value)),
                          color: const Color(0xff132137),
                        ),
                        child: PageTransitionSwitcher(
                          duration: const Duration(milliseconds: 480),
                          reverse: loginButtonMoveAnimation.value < 0.7,
                          ...
                          child: loginButtonMoveAnimation.value > 0.7
                              ? InkWell(
                              ...
                              : InkWell(
                                  ...
                                  onTap: (){
                                    Get.to(ChattingView(animationController: animationController));
                                  },
                                  child: const Padding(
